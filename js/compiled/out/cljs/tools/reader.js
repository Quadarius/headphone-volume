...
var G__29662 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__29662;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__29663 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__29663,ch);
...
if(("\\" === ch__$1)){
var ch_29664__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_29664__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_29664__$2);
} else {
}

var G__29665 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__29665;
continue;
}
}
...
var vec__29673 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__29673,(0),null);
var start_column = cljs.core.nth.call(null,vec__29673,(1),null);
...
var G__29676 = cljs.core.conj_BANG_.call(null,a,form);
a = G__29676;
continue;
}
}
...
var _STAR_read_delim_STAR_29677 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_29677;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__29678 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__29678,(0),null);
var start_column = cljs.core.nth.call(null,vec__29678,(1),null);
...
var vec__29681 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__29681,(0),null);
var end_column = cljs.core.nth.call(null,vec__29681,(1),null);
...
var vec__29684 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__29684,(0),null);
var start_column = cljs.core.nth.call(null,vec__29684,(1),null);
...
var vec__29687 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__29687,(0),null);
var end_column = cljs.core.nth.call(null,vec__29687,(1),null);
...
var vec__29690 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__29690,(0),null);
var start_column = cljs.core.nth.call(null,vec__29690,(1),null);
...
var vec__29693 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__29693,(0),null);
var end_column = cljs.core.nth.call(null,vec__29693,(1),null);
...
var sb = (function (){var G__29696 = (new goog.string.StringBuffer());
G__29696.append(initch);
...
var G__29698 = (function (){var G__29697 = sb;
G__29697.append(ch);

return G__29697;
})();
var G__29699 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__29698;
ch = G__29699;
continue;
}
...
switch (G__29702) {
case "\\":
var G__29706 = (function (){var G__29703 = sb;
G__29703.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__29703;
})();
var G__29707 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__29706;
ch = G__29707;
continue;
...
break;
default:
var G__29708 = (function (){var G__29704 = sb;
G__29704.append(ch);

return G__29704;
})();
var G__29709 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__29708;
ch = G__29709;
continue;
...
var vec__29710 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__29710,(0),null);
var end_column = cljs.core.nth.call(null,vec__29710,(1),null);
...
var vec__29713 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__29713,(0),null);
var column = cljs.core.nth.call(null,vec__29713,(1),null);
...
var vec__29718 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__29718,(0),null);
var column = cljs.core.nth.call(null,vec__29718,(1),null);
...
var vec__29723 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__29723,(0),null);
var column = cljs.core.nth.call(null,vec__29723,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__29728 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__29728,(0),null);
var start_column = cljs.core.nth.call(null,vec__29728,(1),null);
...
var vec__29731 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__29731,(0),null);
var end_column = cljs.core.nth.call(null,vec__29731,(1),null);
...
var G__29734 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__29734,true,null,opts,pending_forms);
...
var G__29735 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__29735)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__29735)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__29735)){
...
var _STAR_suppress_read_STAR_29736 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_29736;
}});
...
var G__29737 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__29737,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__29737,rdr,first_line);
...
var G__29741 = matched;
var G__29742 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__29741;
finished = G__29742;
continue;
} else {
...
var _STAR_suppress_read_STAR_29743 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_29743;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env29744 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__29745 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__29745,"(");
...
var G__29746 = (i + (1));
var G__29747 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env29744;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__29748 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__29748);
...
var G__29749 = cljs.core.next.call(null,s__$1);
var G__29750 = ret;
s__$1 = G__29749;
r = G__29750;
continue;
...
var G__29751 = cljs.core.next.call(null,s);
var G__29752 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__29751;
key_vals = G__29752;
continue;
} else {
...
var gensym_env29756 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env29756;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__29757 = token;
var G__29757__$1 = (((G__29757 == null))?null:cljs.core.subs.call(null,G__29757,(1)));
var G__29757__$2 = (((G__29757__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__29757__$1));
var G__29757__$3 = (((G__29757__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__29757__$2));
var G__29757__$4 = (((G__29757__$3 == null))?null:cljs.core.symbol.call(null,G__29757__$3));
if((G__29757__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__29757__$4);
}
})():(function (){var G__29758 = token;
var G__29758__$1 = (((G__29758 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__29758));
if((G__29758__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__29758__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e29765){if((e29765 instanceof Error)){
var e = e29765;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__29769,reader){
var map__29770 = p__29769;
var map__29770__$1 = ((((!((map__29770 == null)))?(((((map__29770.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29770.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29770):map__29770);
var opts = map__29770__$1;
var eof = cljs.core.get.call(null,map__29770__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq29776){
var G__29777 = cljs.core.first.call(null,seq29776);
var seq29776__$1 = cljs.core.next.call(null,seq29776);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29777,seq29776__$1);
});


//# sourceMappingURL=reader.js.map?rel=1530931629304
