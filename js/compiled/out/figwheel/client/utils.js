...
return (new CustomEvent(event_name,(function (){var obj35763 = {"detail":data};
return obj35763;
})()));
} else {
...
var f = (function (){var pred__35770 = cljs.core._EQ_;
var expr__35771 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35770.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35771))){
return ((function (pred__35770,expr__35771){
return (function (p1__35764_SHARP_){
return console.warn(p1__35764_SHARP_);
});
;})(pred__35770,expr__35771))
} else {
if(cljs.core.truth_(pred__35770.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35771))){
return ((function (pred__35770,expr__35771){
return (function (p1__35765_SHARP_){
return console.debug(p1__35765_SHARP_);
});
;})(pred__35770,expr__35771))
} else {
if(cljs.core.truth_(pred__35770.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35771))){
return ((function (pred__35770,expr__35771){
return (function (p1__35766_SHARP_){
return console.error(p1__35766_SHARP_);
});
;})(pred__35770,expr__35771))
} else {
return ((function (pred__35770,expr__35771){
return (function (p1__35767_SHARP_){
return console.log(p1__35767_SHARP_);
});
;})(pred__35770,expr__35771))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35774){
...
var eval_fn = cljs.core.get.call(null,map__35775__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35777_SHARP_);
});})(new_def))
);
...
return (function (p__35778){
var vec__35779 = p__35778;
var ky = cljs.core.nth.call(null,vec__35779,(0),null);
var v = cljs.core.nth.call(null,vec__35779,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1530931635087
