...
}catch (e30266){var _e = e30266;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___30269 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___30269)){
var seen_errors_30270 = temp__5455__auto___30269;
if(cljs.core.truth_(seen_errors_30270.has(self))){
} else {
seen_errors_30270.add(self);

var temp__5457__auto___30271 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___30271)){
var sense_30272 = temp__5457__auto___30271;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30272)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1530931630505
