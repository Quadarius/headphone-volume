...
var temp__5455__auto____$1 = (o25914["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25915 = temp__5455__auto____$1;
return (o25915["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24846__auto__ = f;
return (o__24846__auto__["toString"]).call(o__24846__auto__);
} else {
return "";
}
}catch (e25916){var _ = e25916;
return "";
}});
...
try{var o__24846__auto___25918 = t;
(o__24846__auto___25918["cljs$lang$ctorPrWriter"]).call(o__24846__auto___25918,t,writer);
}catch (e25917){var __25919 = e25917;
}
...
var char_code = (function (){var o__24846__auto__ = (new String(char$));
return (o__24846__auto__["charCodeAt"]).call(o__24846__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24846__auto__ = String;
return (o__24846__auto__["fromCharCode"]).call(o__24846__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25920 = num_code;
switch (G__25920) {
case (1):
return (185);
...
var o__24846__auto__ = String;
return (o__24846__auto__["fromCharCode"]).call(o__24846__auto__,superscript_code);
});
/**
...
}catch (e25922){var _e__24853__auto__ = e25922;
return false;
}})())){
...
var vec__25923 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25923,(0),null);
...
var temp__5455__auto____$1 = (o25926["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25927 = temp__5455__auto____$1;
return (o25927["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25930){
var vec__25931 = p__25930;
var ns_detector = cljs.core.nth.call(null,vec__25931,(0),null);
...
var G__25937 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25938 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25937;
remaining_tokens = G__25938;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25928){
var G__25929 = cljs.core.first.call(null,seq25928);
var seq25928__$1 = cljs.core.next.call(null,seq25928);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25929,seq25928__$1);
});
...
var vec__25942 = cljs.core.split_with.call(null,(function (p1__25941_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25941_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25942,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25942,(1),null);
...
var vec__25945 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25945,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25945,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25948 = cljs.core.rest.call(null,remaining_tokens);
var G__25949 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25948;
name_tokens = G__25949;
continue;
} else {
...
var vec__25952 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25952,(0),null);
var arity = cljs.core.nth.call(null,vec__25952,(1),null);
var vec__25955 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25955,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25955,(1),null);
var vec__25958 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25958,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25958,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25958,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25958,(3),null);
...
var vec__25964 = result;
var munged_ns = cljs.core.nth.call(null,vec__25964,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25964,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25964,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25964,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25964,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__25968 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__25968,(0),null);
var args = cljs.core.nth.call(null,vec__25968,(1),null);
var vec__25971 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25971,(0),null);
var name = cljs.core.nth.call(null,vec__25971,(1),null);
...
var G__25974 = (arity + (1));
var G__25975 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25976){
var vec__25977 = p__25976;
var arity = cljs.core.nth.call(null,vec__25977,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25977,(1),null);
...
return cljs.core.get.call(null,arities,p1__25980_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25981_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___25988 = arguments.length;
var i__4500__auto___25989 = (0);
while(true){
if((i__4500__auto___25989 < len__4499__auto___25988)){
args__4502__auto__.push((arguments[i__4500__auto___25989]));

var G__25990 = (i__4500__auto___25989 + (1));
i__4500__auto___25989 = G__25990;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25984){
var vec__25985 = p__25984;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25985,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25982){
var G__25983 = cljs.core.first.call(null,seq25982);
var seq25982__$1 = cljs.core.next.call(null,seq25982);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25983,seq25982__$1);
});
...
var G__25991 = arg;
var G__25991__$1 = (((G__25991 instanceof cljs.core.Keyword))?G__25991.fqn:null);
switch (G__25991__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25993__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25993__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25993__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25993__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25994 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25994,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25994,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25994,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25994,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25994,(4),null);
var arity = cljs.core.nth.call(null,vec__25994,(5),null);
...
var o__24846__auto__ = f;
return (o__24846__auto__["getBasis"]).call(o__24846__auto__);
});
/**
...
}catch (e25998){var _e__24853__auto__ = e25998;
...
var G__25999 = (obj[cljs.core.first.call(null,path)]);
var G__26000 = cljs.core.rest.call(null,path);
obj = G__25999;
path = G__26000;
continue;
} else {
...
return (function (accum,p__26001){
var vec__26002 = p__26001;
var bit = cljs.core.nth.call(null,vec__26002,(0),null);
var protocol = cljs.core.nth.call(null,vec__26002,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26005){
var vec__26006 = p__26005;
var ns = cljs.core.nth.call(null,vec__26006,(0),null);
var name = cljs.core.nth.call(null,vec__26006,(1),null);
var selector = cljs.core.nth.call(null,vec__26006,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26011,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26011,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26011,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26009_SHARP_){
return (obj[cljs.core.first.call(null,p1__26009_SHARP_)]);
});})(name,sorted_matches,vec__26011,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1530931620564
